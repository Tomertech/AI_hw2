...
"""
from SearchAlgos import AlphaBeta, AlphaBeta_simple_heuristic
...
class Player(AbstractPlayer):
    def __init__(self, game_time, penalty_score):
        ...
        self.rival_pos = None
        self.alphabeta = AlphaBeta_simple_heuristic(self.utility, self.succ, self.perform_move, self.goal)
        self.scores = [0, 0]
    ...
    def make_move(self, time_limit, players_score):
        ...
        score, move = self.alphabeta.search(copy.deepcopy(player_state), depth=4, maximizing_player=True)
    ...
    def is_only_move(self, move):
        pos = utils.tup_add(self.player_pos, move)
        return self.is_stuck(pos, self.board)
